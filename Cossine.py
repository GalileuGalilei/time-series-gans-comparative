...
from EvaluateTSTR import generate_data
...
def main():
    ...
    fake_dataset = generate_data(attack_increase=True)
    ...
    #_ = compute_dtw_by_class(real_dataset.X_set, real_dataset_shuffled.X_set, real_dataset.Y_set, real_dataset_shuffled.Y_set)
