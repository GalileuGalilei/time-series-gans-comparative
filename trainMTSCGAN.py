...
from mts_cgan import cfg
from mts_cgan.MTSCGAN import *
from mts_cgan import train, LinearLrDecay, load_params, copy_params, cur_stages
from mts_cgan.utils import *
...
#                 raise NotImplementedError('{} unknown inital type'.format(args.init_type))
   ...
   #load dataset
    ...
    train_set = load_and_preprocess_data("data/train.csv", features_to_train, "Stage", seq_len, is_train=True)
    ...
    num_classes = train_set.Y_set.shape[1]
    ...
    print(gen_net)
    dis_net = Discriminator(in_channels=num_channels, patch_size=1, seq_length=seq_len, depth=3, n_classes=num_classes)
    print(dis_net)
