...
locals().update(settings) #C:\Users\Alfredo\source\repos\cyberdata-improvement-tts-cgan\RGAN\experiments\settings\test.txt
...
eval_real_PH = tf.placeholder(tf.float32, [eval_eval_size, settings['seq_length'], settings['num_generated_features']])
eval_sample_PH = tf.placeholder(tf.float32, [eval_eval_size, settings['seq_length'], settings['num_generated_features']])
n_sigmas = 2
...
t0 = time()
best_epoch = 0
print('epoch/ttime/tD_loss/tG_loss/tmmd2/tthat/tpdf_sample/tpdf_real')
