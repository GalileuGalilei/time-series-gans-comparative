...
def _linear(args, output_size, bias, bias_start=0.0, scope=None):
  ...
  """
  # Use is_sequence_or_composite if available, else fallback to is_sequence or isinstance
  is_sequence = getattr(nest, "is_sequence_or_composite", getattr(nest, "is_sequence", None))
