...
class mitbih_train(Dataset):
    def __init__(self, filename='/kaggle/input/ecg-heartbeat/data/mitbih_train.csv', n_samples=20000, oneD=False):
...
class mitbih_test(Dataset):
    def __init__(self, filename='/kaggle/input/ecg-heartbeat/data/mitbih_test.csv', n_samples=1000, oneD=False):
